...
def xor_hex(cipher_hex: str) -> str:
...
async def predict_crypto_from_text(payload: CipherTextRequest):
    ...
    try:
        ...
        if pred == 0:
            ...
            # Aquí podrías usar xor_hex directamente si siempre viene hex
            decoded_text = xor_hex(payload.texto_cifrado)
            # o si quieres mantener la versión antigua:
